...
from ui.collection import CollectionViewWidget
from ui.disbursement import DisbursementViewWidget
...
class MenuBar(FMenuBar, FWidget):
    ...
    def __init__(self, parent=None, admin=False, *args, **kwargs):
        ...
        menu = [
            {"name": u"Encaissement", "icon": 'encais', "admin":
             False, "shortcut": "Ctrl+e", "goto": CollectionViewWidget},
            {"name": u"Decaissement", "icon": 'decais', "admin":
             False, "shortcut": "Ctrl+d", "goto": DisbursementViewWidget},
        ]
